...
namespace Talleres.Infraestructura.Persistencia.Migraciones
{
    ...
    [Migration("20260925175351_RegistrarPagosClientes")]
    partial class RegistrarPagosClientes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Talleres.Dominio.Entidades.OrdenServicio", b =>
                {
                    ...
                    b.Property<long?>("TecnicoTallerId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("EmpresaId", "TecnicoTallerId");
            ...
            modelBuilder.Entity("Talleres.Dominio.Entidades.TecnicoTaller", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("TecnicosTaller", (string)null);
                });
            ...
            modelBuilder.Entity("Talleres.Dominio.Entidades.OrdenServicio", b =>
                {
                    ...
                    b.HasOne("Talleres.Dominio.Entidades.TecnicoTaller", "TecnicoTaller")
                        .WithMany("OrdenesServicio")
                        .HasForeignKey("EmpresaId", "TecnicoTallerId")
                        .HasPrincipalKey("EmpresaId", "Id")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("Cliente");

                    b.Navigation("TecnicoTaller");
